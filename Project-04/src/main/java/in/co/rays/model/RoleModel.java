...
/**
 * RoleModel handles all database operations related to the Role entity,
 * including add, update, delete, find, and search functionalities.
 * 
 * @author Amit
 * @version 1.0
 */
...
public class RoleModel {
	...
	/**
	 * Returns the next available primary key for st_role table.
	 *
	 ...
	 *
	 * @param bean RoleBean object containing role data
	 * @return primary key of the inserted role
	 ...
	 *
	 * @param bean RoleBean containing the ID of the role to be deleted
	 ...
	 *
	 * @param bean RoleBean with updated role data
	 * @throws ApplicationException     if a database exception occurs
	 * @throws DuplicateRecordException if a role with the same name already exists
	 */
	...
	/**
	 * Searches for roles based on given criteria with optional pagination.
	 *
	 * @param bean     RoleBean with search criteria (can be null)
	 * @param pageNo   page number for pagination (starting from 1)
	...
	/**
	 * Finds a role by its primary key (ID).
	 *
